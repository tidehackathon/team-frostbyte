...
def extract_data_from_file(file_path):
    ...
    try:
        ...
        nameTd,maturityTD=bodyContent.findAll('table', class_='wikitable')[1].findAll('td')[0],bodyContent.findAll('table', class_='wikitable')[1].findAll('td')[1]
        ...
        interoperabilityachievements=bodyContent.find('div',id='Final_Report').find('div',class_='grid').findAll('div',class_='panel')[0].text
        ...
        interoperabilityachievements=[x.replace('\u2022','') for x in interoperabilityachievements]
                                                                                                                                                                                                                        
        interoperabilityimprovements=bodyContent.find('div',id='Final_Report').find('div',class_='grid').findAll('div',class_='panel')[1].text
        ...
        interoperabilityimprovements=[x.replace('\u2022','') for x in interoperabilityimprovements]

        interoperabilitychallenges=bodyContent.find('div',id='Final_Report').find('div',class_='grid').findAll('div',class_='panel')[2].text
        ...
        interoperabilitychallenges=[x.replace('\u2022','') for x in interoperabilitychallenges]
        ...
        pathToSave='../../../../../data/normalized/cwix22/cc/'+fileId
...
extract_data_from_directory('../../../../../data/raw/cwix22/cc')
